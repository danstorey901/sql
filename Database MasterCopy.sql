...
INSERT ClassGrade (Grade, GPA) VALUES ('F',0.0);create table Major (
...
INSERT Major (Code, Description, MinSAT) VALUES ('GENS','General Studies', 500);create table Student (
Id int primary key identity(1,1),
...
INSERT Student VALUES('Jessica', 'Patrick','IL',1452,2.60,(SELECT Id from Major where Code = 'ACCT'));create table Instructor (
Id int primary key identity(1,1),
Firstname varchar(30) not null,
Lastname varchar(30) not null,
...
INSERT Instructor VALUES ('Kathy','Miller',21,1);declare @downey int;
...
INSERT class (Code, Subject,Section,InstructorId) VALUES('ENG303','English',303,@downey);INSERT class (Code, Subject,Section,InstructorId) VALUES('MAT201','Math',201,@hunt);
...
INSERT class (Code, Subject,Section,InstructorId) VALUES('MAT404','Math',404,@hunt);INSERT class (Code, Subject,Section,InstructorId) VALUES('HIS101','History',101,@miller);
INSERT class (Code, Subject,Section,InstructorId) VALUES('HIS201','History',201,@miller);
INSERT class (Code, Subject,Section,InstructorId) VALUES('HIS301','History',301,@miller);INSERT class (Code, Subject,Section,InstructorId) VALUES('CSC311','Computer Science',311,@tensi);
...
INSERT class (Code, Subject,Section,InstructorId) VALUES('CSC443','Computer Science',443,@tensi);INSERT class (Code, Subject,Section,InstructorId) VALUES('PSY101','Psychology',101,@brock);
...
INSERT class (Code, Subject,Section,InstructorId) VALUES('PSY232','Psychology',232,@brock);INSERT class (Code, Subject,Section,InstructorId) VALUES('EDU221','Education',221,@schell);
...
INSERT class (Code, Subject,Section,InstructorId) VALUES('EDU353','Education',353,@schell);create table Assignment (
Id int primary key identity(1,1),
...
INSERT MajorClass (MajorId, ClassId) VALUES (
(SELECT Id From Major Where Code = @genbus),
(SELECT Id From Class Where Code = 'PSY101'));declare @acct nvarchar(4) = 'ACCT';
INSERT MajorClass (MajorId, ClassId) VALUES (
...
INSERT MajorClass (MajorId, ClassId) VALUES (
(SELECT Id From Major Where Code = @acct),
(SELECT Id From Class Where Code = 'CSC312'));declare @fin nvarchar(4) = 'FIN';
INSERT MajorClass (MajorId, ClassId) VALUES (
...
INSERT MajorClass (MajorId, ClassId) VALUES (
(SELECT Id From Major Where Code = @fin),
(SELECT Id From Class Where Code = 'CSC311'));declare @math nvarchar(4) = 'MATH';
INSERT MajorClass (MajorId, ClassId) VALUES (
...
INSERT MajorClass (MajorId, ClassId) VALUES (
(SELECT Id From Major Where Code = @math),
(SELECT Id From Class Where Code = 'MAT401'));declare @eng nvarchar(4) = 'ENG';
INSERT MajorClass (MajorId, ClassId) VALUES (
...
INSERT MajorClass (MajorId, ClassId) VALUES (
(SELECT Id From Major Where Code = @eng),
(SELECT Id From Class Where Code = 'MAT401'));declare @educ nvarchar(4) = 'EDUC';
INSERT MajorClass (MajorId, ClassId) VALUES (
...
INSERT MajorClass (MajorId, ClassId) VALUES (
(SELECT Id From Major Where Code = @educ),
(SELECT Id From Class Where Code = 'EDU222'));create table StudentClass (
Id int primary key identity(1,1),
...
INSERT StudentClass (StudentId, ClassId, ClassGradeValue) VALUES (
(SELECT Id from Student Where Lastname = 'Ant'),
(SELECT Id from Class Where Code = 'CSC311'), 'C+');INSERT StudentClass (StudentId, ClassId, ClassGradeValue) VALUES (
